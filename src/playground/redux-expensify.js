...
const expenseOne = store.dispatch(
  addExpense({ description: 'Rent', amount: 200, createdAt: 12000 })
);
const expenseTwo = store.dispatch(
  addExpense({ description: 'Coffee', amount: 30, createdAt: 1000 })
);
const expenseThree = store.dispatch(
  addExpense({ description: 'Supplies', amount: 50, createdAt: -2000 })
);
const expenseFour = store.dispatch(
  addExpense({ description: 'Gifts', amount: 5000, createdAt: 40 })
);
